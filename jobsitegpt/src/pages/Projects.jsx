...
export default function Projects() {
  ...
  return (
    <div className="fade-up">
      ...
      {showNew && (
        <div className="fl-card fade-up" style={{ marginBottom: 28, border: "1.5px solid #f0a500" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {projects.map(p => (
            <div key={p.id} onClick={() => navigate(`/projects/${p.id}`)}
              style={{ background: "#ffffff", border: "1.5px solid #e0e4ef", padding: "18px 22px", cursor: "pointer", transition: "all 0.15s", display: "flex", alignItems: "center", gap: 16, borderRadius: 8 }}
